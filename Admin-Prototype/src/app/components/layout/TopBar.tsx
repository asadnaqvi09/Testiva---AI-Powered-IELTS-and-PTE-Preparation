          ...
          {showNotif && (
            <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                <span className="font-semibold text-sm text-gray-800">Activity Feed</span>
                <button 
                  onClick={markAllRead}
                ...
                {loading ? (
                  ...
                  notifications.map(n => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center" style={{ background: config.bg, color: config.color }}>
                          {config.icon}
                        </div>
              ...
              <div className="px-4 py-2 text-center border-t border-gray-100">
                <button className="text-xs font-semibold text-blue-600 py-1 w-full hover:bg-blue-50 rounded transition-colors">
                  View Full Audit Log
                </button>
              </div>
            </div>
