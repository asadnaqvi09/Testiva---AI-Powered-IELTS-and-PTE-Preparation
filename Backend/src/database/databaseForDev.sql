-- ============================================================
-- Testiva FYP - PostgreSQL Database
-- PgAdmin4 mein paste karein aur execute karein
-- ============================================================

CREATE DATABASE "Testiva_FYP"
...
CREATE TABLE public.refresh_tokens (
    id integer DEFAULT nextval('public.refresh_tokens_id_seq') NOT NULL,
...
CREATE TABLE public.tests (
    ...
    difficulty_level public.difficulty_enum DEFAULT 'medium',
    is_premium boolean DEFAULT false,
    test_category public.test_category_enum DEFAULT 'full_mock' NOT NULL,
...
CREATE TABLE public.test_sections (
    ...
    instructions text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    question_types_allowed jsonb DEFAULT '[]',
...
CREATE TABLE public.questions (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    difficulty public.difficulty_enum DEFAULT 'medium',
    tags jsonb DEFAULT '[]',
    image_url text,
...
CREATE TABLE public.test_attempts (
    ...
    CONSTRAINT test_attempts_sync_status_check CHECK (sync_status = ANY (ARRAY['pending', 'synced', 'failed']))
);
...
CREATE TABLE public.posts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    topic_tag public.topic_tag DEFAULT 'General' NOT NULL,
...
ALTER TABLE ONLY public.temp_users ADD CONSTRAINT temp_users_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.temp_users ADD CONSTRAINT temp_users_email_key UNIQUE (email);
ALTER TABLE ONLY public.temp_users ADD CONSTRAINT temp_users_email_unique UNIQUE (email);
ALTER TABLE ONLY public.temp_users ADD CONSTRAINT temp_users_email_type_unique UNIQUE (email, type);
...
ALTER TABLE ONLY public.test_sections ADD CONSTRAINT test_sections_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.test_sections ADD CONSTRAINT unique_test_section_order UNIQUE (test_id, order_number);

ALTER TABLE ONLY public.questions ADD CONSTRAINT questions_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.test_attempts ADD CONSTRAINT test_attempts_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.user_responses ADD CONSTRAINT user_responses_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.prep_media ADD CONSTRAINT prep_media_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.moderation_log ADD CONSTRAINT moderation_log_pkey PRIMARY KEY (id);
...
INSERT INTO public.users (id, email, password_hash, full_name, avatar_url, auth_provider, role, is_email_verified, last_login_at, created_at, updated_at, subscription, token_version, bio, preference, fcm_token) VALUES
('660c49f1-a752-420e-a27c-fe53a73d71db', 'nasad8569@gmail.com', '$2b$10$tF7HIGDtS.Fh1RL55vo0nuttSq3MWs1Up6KyIjgaj6BRdAk4Req6W', 'Admin Asad', NULL, 'email', 'user', true, '2026-05-09 13:00:57.091733', '2026-04-30 23:18:29.343738', '2026-05-13 22:15:36.866147', 'premium', 1, 'No bio provided', 'IELTS', NULL),
('7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'ragesr56@gmail.com', '$2b$10$nHu4qCDEUz4Dm6jmoaVIke7QdKDvlG8VeFZ464xGw5OnbqPpYZkii', 'Asad Abbas', NULL, 'email', 'admin', true, '2026-05-16 10:17:17.720645', '2026-05-09 13:29:44.911295', '2026-05-14 12:10:45.552511', 'free', 0, 'This is my bio', 'PTE', NULL),
('f81c2b76-cf4c-4718-8872-ba3afc90af2a', 'azadari87@gmail.com', '$2b$10$NPAPGjSARlJQjF1INwK.Oexf5jMOwGA2iEUBFHSmDRtzZQ9.GaxAG', 'TestFlow IELTS 2', NULL, 'email', 'user', true, '2026-05-09 13:53:13.798891', '2026-05-09 13:52:27.379741', '2026-05-13 20:09:59.576838', 'free', 0, 'No bio provided', 'IELTS', NULL);

-- ============================================================
-- DATA: temp_users
-- ============================================================

INSERT INTO public.temp_users (id, email, full_name, password_hash, otp_code, expires_at, created_at, type, is_verified, attempts) VALUES
('ac6283fb-b544-406f-8be5-ed08f20652af', 's23-0385@student.uoh.edu.pk', 'S23-0385', '$2b$10$5xiU8XjC0mvUs61baMzlw.zIIjbpVAJVBs8JzIYL6Bza4NJIt7whS', '$2b$10$N38JiSP1xPKYXAGExAyw5udbV5hbogaCdtFbPKsGhzK83MHZi027W', '2026-05-14 13:00:01.3', '2026-05-14 12:45:01.301943', 'register', false, 0);
...
(48, '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI3YzdlNWM5ZS1lYWQ3LTRhOWEtYTc2MS0zNzNiNjEyMWMxOGUiLCJ0b2tlbklkIjoiOTkwYjZjNjItNDU3YS00MWMzLWJmYTAtZjVhZjRkOGIzNWJlIiwiaWF0IjoxNzc4NzUxMzYzLCJleHAiOjE3NzkzNTYxNjN9.u3LBNXllYVPSGZaevXPFPbhCrzoy5b_tBrTUYrHt5XE', '2026-05-21 14:36:03.958', '2026-05-14 14:36:03.958401'),
(51, '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI3YzdlNWM5ZS1lYWQ3LTRhOWEtYTc2MS0zNzNiNjEyMWMxOGUiLCJ0b2tlbklkIjoiNWVjNjJmZjktNTkxYS00NWExLWEzYWQtYjExN2ZiYjNmZGY0IiwiaWF0IjoxNzc4ODczNjQxLCJleHAiOjE3Nzk0Nzg0NDF9.8LyhXtwhzrgQ0AO-dCe2XSBX_jJU7ujBydD2GrPHYCM', '2026-05-23 00:34:01.626', '2026-05-16 00:34:01.627981'),
(52, '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI3YzdlNWM5ZS1lYWQ3LTRhOWEtYTc2MS0zNzNiNjEyMWMxOGUiLCJ0b2tlbklkIjoiODYzNmFlZDctZWVlNS00ZjY2LWFiZWItMTRmYzM2YzRhNDU0IiwiaWF0IjoxNzc4OTA4NjM3LCJleHAiOjE3Nzk1MTM0Mzd9.a62BlLcyfOB67Z2L30brzZYloM4Qw6LM2xvep9_ob60', '2026-05-23 10:17:17.681', '2026-05-16 10:17:17.682115');
...
INSERT INTO public.admin_logs (id, admin_id, action, target_user_id, details, created_at) VALUES
('9b548522-4ceb-4ebf-a89b-4e4acfe95fec', '660c49f1-a752-420e-a27c-fe53a73d71db', 'Subscription Change', NULL, '{"message": "Changed subscription to basic"}', '2026-04-30 23:36:14.098673'),
('a54b095f-29d7-42e4-94a8-74e89cceaf58', '660c49f1-a752-420e-a27c-fe53a73d71db', 'Subscription Change', NULL, '{"message": "Changed subscription to basic"}', '2026-05-03 13:31:46.098364'),
('4aed160a-ac29-4c56-802b-135ab78bec83', '660c49f1-a752-420e-a27c-fe53a73d71db', 'Subscription Change', NULL, '{"message": "Changed subscription to free"}', '2026-05-03 13:31:49.257461'),
('ffcc1b03-8eba-4c3d-9fd7-624be7a2735d', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to premium"}', '2026-05-13 19:45:30.979932'),
('a271ab01-d058-4848-bdca-ad5bb8299579', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to premium"}', '2026-05-13 19:58:16.329467'),
('d917f0f9-f7b0-44a0-96a4-f133eee9a2af', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to premium"}', '2026-05-13 20:06:50.307906'),
('2137649c-9492-4873-9601-faa26821f339', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', 'f81c2b76-cf4c-4718-8872-ba3afc90af2a', '{"message": "Changed subscription to free"}', '2026-05-13 20:09:59.581323'),
('4d1c22ab-7ea9-4180-ad81-934d6500cbf7', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to premium"}', '2026-05-13 20:17:23.858769'),
('669341ca-cd95-4032-8803-02c1ee4da87a', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:17:35.804385'),
('66696687-12b7-44ab-90c4-4c414098f905', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:24:41.304062'),
('c448382e-a89b-4dc1-997b-23921e854895', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:26:33.735065'),
('19236726-b1c2-4715-a935-0387f4f8b1c6', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:34:55.921935'),
('78105c3f-3055-4723-9d52-34f7b9030e79', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:35:08.065972'),
('702682e0-edb2-4675-9dc5-30dcb86fc192', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:35:11.737799'),
('a4f410de-a858-4a98-9d78-6aea59538dd2', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:36:09.230081'),
('146ee0ed-b748-45c2-bb77-0105f608d26d', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to free"}', '2026-05-13 20:41:26.38322'),
('c90e95e6-e669-4a4d-b82b-e5a198770977', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', 'Subscription Change', '660c49f1-a752-420e-a27c-fe53a73d71db', '{"message": "Changed subscription to premium"}', '2026-05-13 22:15:36.836687');

-- ============================================================
-- DATA: preparations
-- ============================================================

INSERT INTO public.preparations (id, title, test_type, section, summary, status, created_at, updated_at) VALUES
('0743bc02-cbee-4ed7-9b77-59951d3d83e8', 'IELTS Writing', 'IELTS', 'Writing', 'A comprehensive guide to structuring IELTS Writing Tasks', 'published', '2026-05-13 10:39:01.829403', '2026-05-13 10:40:33.119716'),
('a01ad9f9-11af-4d58-8679-6bab26d6e75c', 'IELTS Reading', 'IELTS', 'Reading', 'Learn techniques for skimming and scanning to identify key info quickly', 'published', '2026-05-14 14:24:51.254361', '2026-05-14 14:24:51.254361'),
('98cc1119-6a29-47dc-9435-412e6f097647', 'IELTS Listening', 'IELTS', 'Listening', 'Effective note-taking methods for IELTS Listening section', 'published', '2026-05-14 14:28:32.838539', '2026-05-14 14:28:32.838539'),
...
('30162207-e4e4-4b67-ad0d-3f0f7a77249a', 'PTE Writing High Score Strategy Guide', 'PTE', 'Writing', 'Advanced PTE Writing preparation including essay structure, summarize written text techniques, grammar improvement, vocabulary enhancement, and time management strategies for better writing scores.', 'published', '2026-05-14 14:47:33.536223', '2026-05-14 14:47:33.536223'),
('c5531fba-586a-44dc-ae11-ea966b1ef5b0', 'IELTS Speaking', 'IELTS', 'Speaking', 'How to organize your thoughts and speak fluently in 40 seconds', 'published', '2026-05-14 14:51:42.761617', '2026-05-14 14:51:42.761617');

-- ============================================================
-- DATA: prep_parts
-- ============================================================

INSERT INTO public.prep_parts (id, prep_id, part_title, part_content, order_index) VALUES
('8f48c45b-7604-4a06-b8d8-d0c6668552b2', '0743bc02-cbee-4ed7-9b77-59951d3d83e8', 'Part 1 : Writing Fundamentals', '📚 Task 1 vs Task 2
...
('d4c536b9-a57c-40e8-a093-21f78e6987ba', '0743bc02-cbee-4ed7-9b77-59951d3d83e8', 'Part 2 Essay Writing', '📚 Essay Introduction Template
...
('d0b957fa-7473-4b09-ad33-79fa490276e1', 'a01ad9f9-11af-4d58-8679-6bab26d6e75c', 'Introduction To Reading', '📚 Types of Reading Questions
...
('05f6aaf7-a494-4270-aed1-09f3fbc6a750', 'a01ad9f9-11af-4d58-8679-6bab26d6e75c', 'Advanced Strategies', '📚 True/False/Not Given Mastery
...
('6d9e6322-6fe4-471e-bd79-75b72350e971', 'a01ad9f9-11af-4d58-8679-6bab26d6e75c', 'Practice & Review', '💡 Daily Reading Habit
...
('e7edf4d9-4b74-49fe-bceb-fa567c582e6c', '98cc1119-6a29-47dc-9435-412e6f097647', 'Listening Basics', '📚 Test Structure
...
('346aceda-dda4-49d5-87ee-a4eb98479aff', '98cc1119-6a29-47dc-9435-412e6f097647', 'Advanced Listening', '📚 Multiple Choice Strategies
...
('7f41ed14-e9a7-4934-a35f-04dd12996a7d', 'c5531fba-586a-44dc-ae11-ea966b1ef5b0', 'Advanced Speaking', '📚 Lexical Resource Boost
...
INSERT INTO public.prep_media (id, prep_id, file_url, file_name, created_at, file_size, file_type) VALUES
('41d7b598-2197-4251-a4a0-c2765adce8bb', '0743bc02-cbee-4ed7-9b77-59951d3d83e8', 'https://placeholder.com/ielts-academic-writing-sample-tasks-2023.pdf', 'ielts-academic-writing-sample-tasks-2023.pdf', '2026-05-13 10:39:01.829403', 1, 'application/pdf'),
('3bfb5b21-d519-4d29-be3f-6737fe09b985', 'a01ad9f9-11af-4d58-8679-6bab26d6e75c', 'https://placeholder.com/ielts-academic-reading-sample-tasks-2023.pdf', 'ielts-academic-reading-sample-tasks-2023.pdf', '2026-05-14 14:24:51.254361', 912, 'application/pdf'),
('a8f344d3-dfff-483a-b4da-05facd19d3a6', '98cc1119-6a29-47dc-9435-412e6f097647', 'https://placeholder.com/ielts-listening-sample-tasks-2023.pdf', 'ielts-listening-sample-tasks-2023.pdf', '2026-05-14 14:28:32.838539', 519, 'application/pdf'),
('7041d916-26f3-402c-80db-9cb15d50d204', '3e11922a-537c-4a1e-a936-c79af934ce15', 'https://res.cloudinary.com/dbsfrh5fa/raw/upload/v1778751500/testiva/documents/1778751495115-PTE-Reading-Practice-Test-9.pdf', 'PTE-Reading-Practice.pdf', '2026-05-14 14:39:59.034901', 90096, 'application/pdf'),
('78fff146-43cc-4de4-9154-bcd88cc3f1c7', '0e6a6611-80a1-455e-805f-abd2265d65b4', 'https://res.cloudinary.com/dbsfrh5fa/raw/upload/v1778751870/testiva/documents/1778751865317-PTE-Listening-Practice-Test-7.pdf', 'pte-listening-strategies.pdf', '2026-05-14 14:45:13.788473', 74173, 'application/pdf'),
('67c95f9d-9d3e-4a0a-8079-5d9ce7eb11e4', '0a85f43e-e16e-47dc-93fb-549f705878a3', 'https://res.cloudinary.com/dbsfrh5fa/raw/upload/v1778751984/testiva/documents/1778751980805-PTE-Writing-Practice-test-2.pdf', 'pte-speaking-strategies.pdf', '2026-05-14 14:46:56.777784', 52980, 'application/pdf'),
('469515bd-182f-4246-8324-31421393c538', '30162207-e4e4-4b67-ad0d-3f0f7a77249a', 'https://res.cloudinary.com/dbsfrh5fa/raw/upload/v1778751984/testiva/documents/1778751980805-PTE-Writing-Practice-test-2.pdf', 'pte-writing-strategies.pdf', '2026-05-14 14:47:33.536223', 52980, 'application/pdf'),
('25e8ac12-ed19-4091-9b0d-28544282eeea', 'c5531fba-586a-44dc-ae11-ea966b1ef5b0', 'https://placeholder.com/ielts-speaking-sample-tasks-2023.pdf', 'ielts-speaking-sample-tasks-2023.pdf', '2026-05-14 14:51:42.761617', 470, 'application/pdf');

-- ============================================================
-- DATA: posts
-- ============================================================

INSERT INTO public.posts (id, user_id, topic_tag, title, content, is_flagged, flagged_by, flag_reason, deleted_at, created_at, updated_at) VALUES
('57bb735d-452f-468a-bd1a-dac28b145e2c', 'f81c2b76-cf4c-4718-8872-ba3afc90af2a', 'IELTS', 'Need IELTS writing tips', 'How can I improve coherence and cohesion?', true, 'admin', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', NULL, '2026-05-09 14:01:57.009047+05', '2026-05-13 11:51:53.710632+05');

-- ============================================================
-- DATA: moderation_log
-- ============================================================

INSERT INTO public.moderation_log (id, admin_id, post_id, action, admin_feedback, email_sent, created_at) VALUES
('55b34e80-d69c-49a2-b3b8-e38cc10a07bc', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'flag', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', true, '2026-05-13 11:24:53.478773+05'),
('25c32603-8e1c-4f67-a5ba-cb43ca612a58', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'unflag', NULL, false, '2026-05-13 11:30:17.756328+05'),
('86b2c170-ed8e-4c77-8a79-3e14ec6efbf7', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'flag', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', true, '2026-05-13 11:30:33.834997+05'),
('e13b6f22-c8ce-47e7-a52e-324e3198dd8f', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'unflag', NULL, false, '2026-05-13 11:34:01.248609+05'),
('3fd20ca3-ab98-4495-97dd-14e50e375c2d', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'flag', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', true, '2026-05-13 11:34:16.426602+05'),
('307b6489-ab77-48e3-ba03-92222c5a7626', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'unflag', NULL, false, '2026-05-13 11:44:05.433779+05'),
('b740c8c7-bb28-4211-b104-6367aa0c88b0', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'flag', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', true, '2026-05-13 11:44:16.665802+05'),
('7fc3d0ae-a8f0-4f5d-a04e-40daef082995', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'unflag', NULL, false, '2026-05-13 11:51:47.771761+05'),
('978273a1-5084-4719-ae1c-4a0ec27452da', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '57bb735d-452f-468a-bd1a-dac28b145e2c', 'flag', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', true, '2026-05-13 11:51:55.871951+05');

-- ============================================================
-- DATA: notifications
-- ============================================================

INSERT INTO public.notifications (id, user_id, actor_id, post_id, comment_id, type, title, message, is_read, created_at) VALUES
('f3e6c124-ed5a-4a30-ab52-821aa7ba08f3', 'f81c2b76-cf4c-4718-8872-ba3afc90af2a', NULL, NULL, NULL, 'post_flagged', 'Post Flagged', 'Your post has been removed because it violates our Community Guidelines. Please ensure all content is respectful, relevant, and appropriate for an academic learning environment.', false, '2026-05-13 11:51:55.884527+05'),
('d1c93164-258e-484a-ac1d-c3f3c9f72d12', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '660c49f1-a752-420e-a27c-fe53a73d71db', NULL, NULL, 'admin_subscription_changed', 'Manual Subscription Update', 'Admin Asad''s subscription was manually changed from premium to free.', false, '2026-05-13 20:17:35.818806+05'),
('ea2b4697-9775-476c-8fa9-e53904828084', '7c7e5c9e-ead7-4a9a-a761-373b6121c18e', '660c49f1-a752-420e-a27c-fe53a73d71db', NULL, NULL, 'admin_subscription_changed', 'Manual Subscription Update', 'Admin Asad''s subscription was manually changed from free to premium.', false, '2026-05-13 22:15:37.068036+05');