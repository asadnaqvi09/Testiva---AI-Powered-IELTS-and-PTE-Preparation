              ...
              children: [
                CircleAvatar(
                  ...
                  child: _isLoadingHeader
                      ...
                      : Text(_initials, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          ...
                          style: TextStyle(
                              fontSize: 13,
                              color: _userTier.contains('Premium') ? const Color(0xFFD97706) : Colors.grey,
                              fontWeight: _userTier.contains('Premium') ? FontWeight.bold : FontWeight.normal
                          )
                      ),
                    ],
                  ),
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildDrawerItem(
                  ...
                  text: 'Dashboard Home',
                  isSelected: currentRoute == '/home' || currentRoute == '/dashboard',
                  onTap: () => _navigateToRoute(context, currentRoute, '/home'),
                ),
                _buildDrawerItem(
                  context,
                  ...
                  onTap: () => _navigateToRoute(context, currentRoute, '/prep'),
                ),
                _buildDrawerItem(
                  context,
                  ...
                  onTap: () => _navigateToRoute(context, currentRoute, '/mocks'),
                ),
                _buildDrawerItem(
                  context,
                  ...
                  onTap: () => _navigateToRoute(context, currentRoute, '/profile'),
                ),
                ...
                _buildDrawerItem(
                  ...
                  onTap: () => _navigateToRoute(context, currentRoute, '/settings'),
                ),
                _buildDrawerItem(
                  context,
                  ...
                  onTap: () => _navigateToRoute(context, currentRoute, '/feedback'),
                ),
                _buildDrawerItem(
                  context,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected
            ...
            : (isDarkMode ? const Color(0xFF1E1E1E) : Colors.grey.withOpacity(0.04)),
        borderRadius: BorderRadius.circular(15),
        border: Border.all(
          color: isSelected ? const Color(0xFF007BFF).withOpacity(0.3) : Colors.transparent,
        ),
      ),
      child: ListTile(
        visualDensity: VisualDensity.compact,
        leading: Icon(icon, color: isSelected ? const Color(0xFF007BFF) : Colors.blueGrey),
